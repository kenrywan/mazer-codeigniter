                        ...
                        <div class="dropdown icon-right">
                          ...
                          >
                            <a
                              ...
                              href="#"
                              >Option 1
                              <i class="bi bi-bar-chart-alt-2 ms-2"></i
                            ></a>
                            <a
                              class="dropdown-item justify-content-between"
                              href="#"
                              >Option 2 <i class="bi bi-bell ms-2"></i
                            ></a>
                            <a
                              class="dropdown-item justify-content-between"
                              href="#"
                              >Option 3 <i class="bi bi-time ms-2"></i
                            ></a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="card-content">
                    <div class="card-body">
                      <p>
                        ...
                        <c6de>.dropdown-header</c6de> for the header of groups
                        and for separation of group you can use
