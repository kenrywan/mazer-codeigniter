            ...
            <div class="row">
              <div class="col-12 col-md-6 order-md-1 order-last">
                ...
                <p class="text-subtitle text-muted">
                  Examples for how to use Bootstrap’s included progress
                  components.
                </p>
              </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <p>
                  ...
                  <code>.progress-sm</code> or <code>.progress-lg</code> with
                  <code>.progress</code> to change size of your progress bar.
                </p>
