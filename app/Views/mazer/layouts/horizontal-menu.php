          ...
          <header class="mb-5">
            ...
            <nav class="main-navbar">
              <div class="container">
                <ul>
                  <li class="menu-item">
                    <a href="<?= site_url("mazer"); ?>" class="menu-link">
                      ...
                      <div class="submenu-group-wrapper">
                        <ul class="submenu-group">
                          <li class="submenu-item">
                            <a href="/mazer/components/accordion" class="submenu-link">Accordion</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/alert" class="submenu-link">Alert</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/badge" class="submenu-link">Badge</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/breadcrumb" class="submenu-link">Breadcrumb</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/button" class="submenu-link">Button</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/card" class="submenu-link">Card</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/carousel" class="submenu-link">Carousel</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/collapse" class="submenu-link">Collapse</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/dropdown" class="submenu-link">Dropdown</a>
                          </li>
                        </ul>
                        <ul class="submenu-group">
                          <li class="submenu-item">
                            <a href="/mazer/components/list-group" class="submenu-link">List Group</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/modal" class="submenu-link">Modal</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/navs" class="submenu-link">Navs</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/pagination" class="submenu-link">Pagination</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/progress" class="submenu-link">Progress</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/spinner" class="submenu-link">Spinner</a>
                          </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/toasts" class="submenu-link">Toasts</a>
                        </li>
                          <li class="submenu-item">
                            <a href="/mazer/components/tooltip" class="submenu-link">Tooltip</a>
                          </li>
                          ...
                          <li class="submenu-item has-sub">
                            ...
                            <ul class="subsubmenu">
                              <li class="subsubmenu-item">
                                <a href="/mazer/extra/components/avatar" class="subsubmenu-link">Avatar</a>
                              </li>
